...
import { addPositionActuelToEnseignant } from '../services/backend'; // Vérifiez l'importation du service backend
import Navbar from './Navbar';

function AddPositionActuelle() {
    ...
    const addPositionHandler = (e) => {
        ...
        addPositionActuelToEnseignant(id, position)
            .then((res) => {
                                ...
                                <form onSubmit={addPositionHandler}>
                                    ...
                                    <div className="mb-3">
                                        <button type="button" className="btn btn-primary" onClick={toggleSuperviseurFields}>
                                            {showSuperviseur ? 'Superviseur' : 'Ajouter un Superviseur'}
                                        </button>
                                    </div>
                                    {showSuperviseur && (
                                        <>
...
export default AddPositionActuelle;
